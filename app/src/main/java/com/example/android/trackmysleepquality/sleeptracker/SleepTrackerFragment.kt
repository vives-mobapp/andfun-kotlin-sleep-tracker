...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val sleepNightListener = SleepNightAdapter.SleepNightListener {nightID ->
            sleepTrackerViewModel.onSleepNightDataClicked(nightID)
        }
        val adapter = SleepNightAdapter(sleepNightListener)
        binding.sleepList.adapter = adapter

        sleepTrackerViewModel.navigateToSleepNightData.observe(viewLifecycleOwner, Observer {nightID ->
            nightID?.let {
                this.findNavController().navigate(
